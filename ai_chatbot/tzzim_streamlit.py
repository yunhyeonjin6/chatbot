...
# /clubInfoList : 계정등록된 골프장 정보 API
# /autoLogin : 골프장 "자동로그인"크롤링 API
# /dateSearch : 골프장 "날짜"크롤링 API
# /timeSearch : 골프장 "시간"크롤링 API
# /reserve : 골프장 "예약"크롤링 API


BASE_API_URL = 'http://192.168.0.21:8080'

# 사용자 입력 받기
user_input = st.text_input("API 호출을 위해 '클럽정보', '로그인', '날짜', '시간', '예약' 입력:")
...
if st.button("보내기"):
    ...
    if user_input == '클럽정보':
        ...
        if response.status_code == 200:
            ...
            st.write("HTTP 요청 실패. 상태 코드:", response.status_code)
